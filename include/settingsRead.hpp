// ---------------------------------------------------------
// Leer configuración de los parametros WIFI
// ---------------------------------------------------------
boolean settingsReadWifi(){
    ...
    if(deserializeJson(jsonConfig,file)){
        ...
        strlcpy(wifi_passw,jsonConfig["wifi_pw"],sizeof(wifi_passw));
        ...
        strlcpy(wifi_primaryDNS,jsonConfig["primaryDNS"],sizeof(wifi_primaryDNS));
        strlcpy(wifi_secondaryDNS,jsonConfig["secondaryDNS"],sizeof(wifi_secondaryDNS));
        /*-------------------- AP ---------------------------*/
